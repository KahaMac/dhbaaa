...
import { Briefcase, MapPin, Clock, Building2, Users, Calendar, ArrowLeft, Bookmark, Share2, CheckCircle2 } from "lucide-react"
import Link from "next/link"
import { useState, use } from "react"

export default function JobDetailClient({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
