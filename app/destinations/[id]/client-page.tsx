...
export default function DestinationClient({
  ...
  // Mock destination detail - in real app, fetch based on id
  const destinations = [
    {
      id: "1",
    ...
    },
    {
      ...
      description: "Beautiful lakeside destination with mountain views",
      longDescription: "Pokhara is a beautiful city nestled in the Himalayas, famous for its stunning lakes and mountain views.",
      region: "Pokhara Valley",
      category: "Natural",
      image: "/placeholder.svg",
      gallery: ["/placeholder.svg", "/placeholder.svg"],
      nearbyHotels: [
        { id: "2", name: "Temple Tree Resort", distance: "0.3 km" },
      ],
      highlights: [
        "Phewa Lake",
        "Mountain views",
    ...
    },
    {
      ...
      longDescription: "Chitwan National Park is Nepal's first national park, home to diverse wildlife including rhinos and tigers.",
      region: "Chitwan",
      category: "Wildlife",
      image: "/placeholder.svg",
      gallery: ["/placeholder.svg", "/placeholder.svg"],
      nearbyHotels: [
        { id: "3", name: "Jungle Safari Lodge", distance: "1.0 km" },
      ],
      highlights: [
        "Wildlife safari",
        "Rhino spotting",
